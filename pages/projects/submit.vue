        ...
        <div class="submit__body flex">
          ...
          <div class="submit__right">
            <form @submit.prevent="saveProject" ref="form" class="contacts__form form">
                ...
                <div class="form__info flex">
                  <div class="form__info-value flex">
                    <div class="form__radio form__radio_1">
                      <input type="radio" name="value" v-model="project.active" value="active" data-change="1">
                    ...
                    <div class="form__radio form__radio_2">
                      <input type="radio" name="value" v-model="project.upcoming" value="upcoming" data-change="2">
              ...
              <div class="form__label" v-for="social in project.socials">
                <input type="text" class="form__field field" v-model="social.value" :placeholder="`${social.title} *`">
                  ...
                  <div class="select-social__options">
                    ...
                    >
                      <div class="select-social__options-icon">
                        <img :src="require(`@/assets/img/select-icons/${social.name}.svg`)" alt="">
                      </div>
