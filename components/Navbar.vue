            ...
            <div class="social social_hidden">
              <a href="#" class="social__link flex">
                <div class="social__icon">
                  <img src="@/assets/img/icons/twitter.svg" alt="" width="100%" height="100%">
                </div>
                <div class="social__caption">Twitter</div>
              </a>
              <a href="#" class="social__link flex">
                <div class="social__icon">
                  <img src="@/assets/img/icons/telegram.svg" alt="" width="100%" height="100%">
                </div>
              ...
              <div class="header__search-list">
                <div class="header__search-list__project">
                  ...
                  <ul>
                    <li>
                      <a href="#">
                        <img src="@/assets/img/icons/avatar-project.svg" alt="">
            ...
            <div class="header__cabinet">
              ...
              <div class="header__profile" v-if="$auth.loggedIn">
                ...
                <div class="header__profile-block">
                  <a href="#" class="header__profile-link" @click="logout">logout</a>
                  <a href="#" class="header__profile-link">Personal area</a>
                </div>
              </div>

              <a href="#" class="header__signin signin--js" id="signin" @click="showLoginModal" v-else>Sign In</a>

            </div>
          </div>
          <router-link to="/projects/submit" class="header__btn flex">
